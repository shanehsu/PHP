...
<div class="ui vertical menu" style="max-width: 30rem;">
    ...
    foreach ($categories as $category) {
        switch ($category["depth"]) {
            case 1:
                ?>
                <a class="item" href="category.php?id=<?php echo $category["id"]; ?>"><?php echo $category["name"]; ?></a>
                <?php
                break;
            case 2:
                ?>
                <div class="item">
                    ...
                    <div class="menu">
                        ...
                        foreach ($category["children"] as $child) {
                            ?>
                            <a class="item" href="category.php?id=<?php echo $child["id"]; ?>"><?php echo $child["name"]; ?></a>
                            <?php
                        }
                        ?>
                    </div>
                            ...
                            <div class="ui dropdown item">
                                ...
                                <div class="menu">
                                    ...
                                    foreach ($child["children"] as $grandchild) {
                                        ?>
                                        <a class="item" href="category.php?id=<?php echo $grandchild["id"]; ?>"><?php echo $grandchild["name"]; ?></a>
                                        <?php
                                    }
                                    ?>
                                </div>
